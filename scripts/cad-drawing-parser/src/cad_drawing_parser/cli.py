...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--max-entities", type=int, default=10000, help="最多输出多少个图元记录；0 或负数表示不限制")
    parser.add_argument("--max-texts", type=int, default=2000, help="最多输出多少条文字/尺寸样本；0 或负数表示不限制")
    parser.add_argument("--max-blocks", type=int, default=1000, help="最多输出多少个块定义摘要；0 或负数表示不限制")
